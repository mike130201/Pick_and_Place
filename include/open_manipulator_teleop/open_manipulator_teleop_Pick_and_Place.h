...
#ifndef OPEN_MANIPULATOR_TELEOP_Pick_and_Place_H_
#define OPEN_MANIPULATOR_TELEOP_Pick_and_Place_H_
...
#endif //OPEN_MANIPULATOR_TELEOP_Pick_and_Place_H_
